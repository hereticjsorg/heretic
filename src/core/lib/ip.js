// Fork: https://github.com/pbojinov/request-ip
// The MIT License (MIT)
// Copyright (c) 2022 Petar Bojinov - petarbojinov+github@gmail.com

const is = require("./islib");

const _getClientIpFromXForwardedFor = value => {
    if (!is.existy(value)) {
        return null;
    }
...
const getClientIp = req => {
    ...
    if (req.headers) {
        ...
        const xForwardedFor = _getClientIpFromXForwardedFor(
