...
export default class {
    async onCreate(input, out) {
        ...
        if (input.admin) {
            await import( /* webpackChunkName: "hfximport-admin" */ "./style-admin.scss");
        } else {
            await import( /* webpackChunkName: "hfximport-frontend" */ "./style-frontend.scss");
        }
    ...
    async show() {
        ...
        const importModal = this.getComponent(`importModal_hf_${this.input.id}`);
