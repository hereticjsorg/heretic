        ...
        try {
            ...
            if (
                ...
                try {
                    ...
                    const usersRecords = await this.redis.keys(
                        `${this.systemConfig.id}_user_*`,
                    );
                    ...
                    for (const item of usersRecords.slice(0, 100)) {
                        ...
                        if (
                            lastSeen &&
                            (!online[userId] || online[userId] < lastSeen)
                        ) {
            ...
            if (this.systemConfig.collections.jobs) {
                existingJob = await this.mongo.db
            ...
            return rep.success({
                ...
                systemConfig: {
                    ...
                    oauth2: this.systemConfig.oauth2
                        .filter((i) => i.enabled)
                        .map((i) => i.name),
